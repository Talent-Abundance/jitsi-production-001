...
import { setupVoskTranscriptionOnConference } from './actions.web';
...
MiddlewareRegistry.register(store => next => action => {
    ...
    console.log("🚀 CONFERENCE_JOINED triggered in middleware!");
    // ✅ Start Vosk transcription here
    setupVoskTranscriptionOnConference(action.conference);
